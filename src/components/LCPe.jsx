...
import lcpe from "../assets/images/lcpe.png"
      ...
      <div className="px-4 py-3 container  col-xxl-8" style={{ paddingLeft: "100px", paddingRight: "100px" }}>
        <div className="row flex-lg-row align-items-center g-5 py-5">
          <div className="col-10 col-sm-8 col-lg-6">
            <img src={lcpe} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
          </div>
          <div className="col-lg-6">
            <h1 className="display-5 fw-bold lh-1 mb-5">Message From LCPe Aysha Ajwad !</h1>
